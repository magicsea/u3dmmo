...
namespace AssemblyCSharp
{
	...
	public enum Opcodes
	{
	    ...
	    CMSG_ATTACKSWING                                = 0x141,	// implemented // used by ZWorld(提交战斗开始的申请)
	    CMSG_ATTACKSTOP                                 = 0x142,	// implemented
	    SMSG_ATTACKSTART                                = 0x143,	// implemented // used by ZWorld(返回战报信息)
	    ...
	    SMSG_QUESTGIVER_REQUEST_ITEMS                   = 0x18B,	// implemented // used by ZWorld(载入下一个task level)
        ...
        SMSG_CONNECT_FAILED                             = 0x4F8,    // connect server failed
        CMSG_CHAR_INFO                                  = 0x4F9,    // query char info
        SMSG_CHAR_INFO                                  = 0x4FA,    // return char info
        CMSG_SAVE_SKILL                                 = 0x4FB,	// save skill
        SMSG_SAVE_SKILL                                 = 0x4FC,	// return save skill
        CMSG_SAVE_YONGBING                              = 0x4FD,	// save skill
        SMSG_SAVE_YONGBING                              = 0x4FE,	// return save skill
        CMSG_RANK_CHAR_LIST                             = 0x4FF,    // query rank char list
        ...
        CMSG_TASK_INFO_QUERY                            = 0x600,    // 查询玩家当前主线任务的task信息
        SMSG_TASK_INFO_QUERY_RESPONSE                   = 0x601,    // 返回玩家当前主线任务的task信息

        CMSG_TASK_FIGHT_SUBMIT                          = 0x602,    // 提交task战斗结果
        SMSG_TASK_FIGHT_SUBMIT_RESPONSE                 = 0x603,    // 返回提交task战斗结果的反馈

        CMSG_TASK_DIALOG_QUERY                          = 0x604,	// 请求下一个task对话
        SMSG_TASK_DIALOG                                = 0x605,	// 设置task对话

        CMSG_TASK_FIGHT_START                           = 0x606,	// 发起task战斗
        SMSG_TASK_FIGHT_START                           = 0x607,	// 返回任务怪信息及战报数据，开始task战斗

        // new
        CMSG_TASK_DETAIL_QUERY                          = 0x608,    // 根据指定的taskID，查询相关task的详细信息
        SMSG_TASK_DETAIL_QUERY_RESPONSE                 = 0x609,    // 返回指定的task的详细信息

        CMSG_INSTANCE_FIGHT_START                       = 0x610,	// 发起副本战斗
        SMSG_INSTANCE_FIGHT_START                       = 0x611,	// 返回战报数据，开始副本战斗
        ...
        SMSG_TASK_ADDMARK1                               = 0x830,//增加问号
        SMSG_TASK_ADDMRAK2                               = 0x831,//增加感叹号
        SMSG_TASK_REMOVEMARK1                            = 0x832,//移除问号
        SMSG_TASK_REMOVEMARK2                            = 0x833,//移除感叹号
        SMSG_TASK_LIST                                   = 0x834,//任务列表
        SMSG_TASK_DETAIL                                 = 0x835,//显示任务详细内容
        SMSG_TASK_CHAT                                   = 0x836, //对话
        CMSG_TASK_SELECT                                 = 0x837, //发送选择的checkbox 的index
        CMSG_TASK_PANEL                                  = 0x838, //任务面板信息
        SMSG_TASK_PANEL                                  = 0x839, //任务面板信息
        CMSG_TASK_OPENNPC                                = 0x840, //NPC点开
