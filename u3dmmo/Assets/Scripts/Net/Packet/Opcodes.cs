...
namespace AssemblyCSharp
{
	...
	public enum Opcodes
	{
	    ...
	    CMSG_ATTACKSWING                                = 0x141,	// implemented // used by ZWorld(Ìá½»Õ½¶·¿ªÊ¼µÄÉêÇë)
	    CMSG_ATTACKSTOP                                 = 0x142,	// implemented
	    SMSG_ATTACKSTART                                = 0x143,	// implemented // used by ZWorld(·µ»ØÕ½±¨ÐÅÏ¢)
	    ...
	    SMSG_QUESTGIVER_REQUEST_ITEMS                   = 0x18B,	// implemented // used by ZWorld(ÔØÈëÏÂÒ»¸ötask level)
