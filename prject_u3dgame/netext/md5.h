...
public:
	...
	static void GetMD5(const char* pInput, DWORD nInputLen, BYTE *pOutput);

protected:
	void Update(BYTE* pInput, DWORD nInputLen);
	void Final();
	
	void Transform(BYTE block[64]);
	
	void ByteToDWord(BYTE* pByte, DWORD* pDword, DWORD nByteLen);
	void DWordToByte(DWORD* pDword, BYTE* pByte, DWORD nByteLen);
	
	__inline void FF(DWORD& A, DWORD B, DWORD C, DWORD D, DWORD X, DWORD S, DWORD T);
	__inline void GG(DWORD& A, DWORD B, DWORD C, DWORD D, DWORD X, DWORD S, DWORD T);
	__inline void HH(DWORD& A, DWORD B, DWORD C, DWORD D, DWORD X, DWORD S, DWORD T);
	__inline void II(DWORD& A, DWORD B, DWORD C, DWORD D, DWORD X, DWORD S, DWORD T);
	
	__inline DWORD RotateLeft(DWORD x, int n);
